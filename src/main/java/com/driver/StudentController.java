...
public class StudentController {
    ...
    @PostMapping("/add-student") //end-point
    ...
    public ResponseEntity<String> addTeacher(@RequestBody Teacher teacher){
        studentService.addTeahcer(teacher);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable("teacher") String teacher){
        List<String> students = studentService.studentsByTeacherName(teacher); // Assign list of student by calling service layer method
